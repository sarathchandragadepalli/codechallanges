...
{
    public class GoldAccount : AccountType, IAccountTypes
    {

        public double MinumumBalance { get; } = 0;

        public double Interest { get; } = 0.03;

        public double Penalty { get; } = 0;

        public double Cashback { get; } = 0.01;
        ...
        // Constructor
        public GoldAccount(double accBalance)
        {
