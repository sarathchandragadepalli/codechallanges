    ...
    public class CalculateDisplcaement
    {
        ...
        private static void TakeInputandcalculateLogic()
        {
            ...
            var noofColumns = Convert.ToInt32(Console.ReadLine());
                ...
                Console.WriteLine("please enter the elements { each element followed by enter } ");
            ...
            int i;
                ...
                for (i = 0; i < noofRows; i++)
                {
                    ...
                    {
                        pointsarray[i, j] = Convert.ToInt32(Console.ReadLine());
                ...
                Console.WriteLine("please enter  two input points in array { each element followed by enter } ");
                Point p = new Point();
                Point q = new Point();
                p.X = Convert.ToInt32(Console.ReadLine());
                p.Y = Convert.ToInt32(Console.ReadLine());
                q.X = Convert.ToInt32(Console.ReadLine());
                q.Y = Convert.ToInt32(Console.ReadLine());
